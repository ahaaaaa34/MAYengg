...
const WORDS = [
  ...
  { id: 10, en: 'natural',     ja: '自然の',             lv: '3級',   lvCls: 'lv-3',    ex: "This destroys the animals' habitat – the natural environment where plants or animals usually live.", exJa: 'これは植物や動物が通常生活している自然環境である生息地を破壊します。' },
  { id: 11, en: 'environment', ja: '環境',               lv: '3級',   lvCls: 'lv-3',    ex: "This destroys the animals' habitat – the natural environment where plants or animals usually live.", exJa: 'これは植物や動物が通常生活している自然環境である生息地を破壊します。' },
  ...
  { id: 22, en: 'special',     ja: '特別な',             lv: '3級',   lvCls: 'lv-3',    ex: "Too many are caught to make special dishes that people like to eat, such as shark's fin soup or sushi.", exJa: 'フカヒレスープや寿司など、特別な料理を作るために過剰に捕獲されています。' },
  { id: 23, en: 'dish',        ja: '料理',               lv: '3級',   lvCls: 'lv-3',    ex: "Too many are caught to make special dishes that people like to eat, such as shark's fin soup or sushi.", exJa: 'フカヒレスープや寿司など、特別な料理を作るために過剰に捕獲されています。' },
  ...
  { id: 26, en: 'refuse',      ja: '拒む',               lv: '3級',   lvCls: 'lv-3',    ex: "The public can help out by refusing to buy products made from animals' body parts.", exJa: '一般市民は動物の体の部位から作られた製品を拒むことで助けることができます。' },
  { id: 27, en: 'product',     ja: '製品',               lv: '3級',   lvCls: 'lv-3',    ex: "The public can help out by refusing to buy products made from animals' body parts, such as seal fur coats or crocodile bags.", exJa: '一般市民はアザラシの毛皮コートやワニのバッグなどを買わないことで助けることができます。' },
  ...
  { id: 56, en: 'public',      ja: '一般市民',           lv: '準2級', lvCls: 'lv-pre2', ex: "The public can help out by refusing to buy products made from animals' body parts.", exJa: '一般市民は動物の体の部位から作られた製品を拒むことで助けることができます。' },
  ...
  // 追加単語
  { id: 66, en: 'Earth',       ja: '地球',               lv: '3級',   lvCls: 'lv-3',    ex: "Many species could disappear from the Earth very soon if we don't do anything to save them.", exJa: '私たちが何もしなければ、多くの種がまもなく地球から姿を消してしまうかもしれません。' },
